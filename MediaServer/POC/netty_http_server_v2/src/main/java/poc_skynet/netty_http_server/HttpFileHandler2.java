...
public class HttpFileHandler2 extends SimpleChannelInboundHandler<HttpObject> {
	private static final Logger logger = Logger.getLogger(HttpFileHandler2.class.getName());
	...
	private File baseFolder = new File("src/test/html");
    ...
    public void channelRead0(ChannelHandlerContext ctx, HttpObject msg) throws Exception {
        if (msg instanceof HttpRequest) {
            ...
            if (uri.getPath().startsWith("/test/")){
            	writeFile(ctx, uri.getPath());
            	return;
            }
    ...
    private void writeHttpData(InterfaceHttpData data) {
        if (data.getHttpDataType() == HttpDataType.Attribute) {
            ...
            if (data.getHttpDataType() == HttpDataType.FileUpload) {
                ...
                try {
					System.out.println(fileUpload.getFilename() +": " + fileUpload.getFile().length());
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
